...
if(Which_network=='BARABASI'):
	...
	for Seed in range(1,51):
		path = 'Output_Scale_free_1_init_node/Output_Network_Seed_%04i/Output_0001/Output_alpha_175.00/Output_beta_15.00/' %Seed
	...
	plt.savefig('Scatter_alpha_175_beta_15_statistics.eps')
	plt.close()
