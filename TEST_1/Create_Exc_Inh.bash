...
for alpha in $(seq 00.00 05.00 00.00)
	...
	for beta in $(seq 00.00 05.00 00.00)
		...
		for ((Seed=1;Seed<=1;Seed++))
			...
			python ./Preprocessing/Create_Network.py
			./Run.bash
			mkdir -p Output_Scale_free_1_init_node/Output_Network_Seed_${Num_seed}/Output_0001
			mv Output_00*/* Output_Scale_free_1_init_node/Output_Network_Seed_${Num_seed}/Output_0001/
			rm -r Output_00*
			#export P_Dir="Output_Scale_free_1_init_node_3/Output_Network_Seed_${Num_seed}/Output_0001/Output_alpha_${Num_alpha}/Output_beta_${Num_beta}"
